...
class Babroad:
    ...
    def train(self, config: Configuration, seed: int = 0) -> float:
        with warnings.catch_warnings():
            ...
            train_data = CustomDataset(train_default, ucr_target_train)
            trainloader = DataLoader(train_data, batch_size=20, shuffle=True)
            test_data = CustomDataset(test_default, ucr_target_test)
            ...
            if img_test_acc < test_acc:
                ...
                torch.save(model.state_dict(), PATH + 'MoteStrain(smac3)3.pt')
...
if __name__ == "__main__":
    ucr = fetch_ucr_dataset('MoteStrain', use_cache=False, data_home=None, return_X_y=False)  # 5 class
    ...
    PATH = "C:\\Users\\user\\PycharmProjects\\please\\save\\MoteStrain\\"
    ...
    df_results.to_csv(PATH+"motestrain.csv")
